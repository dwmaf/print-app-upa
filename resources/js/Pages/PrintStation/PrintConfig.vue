...
<template>
    <div
        class="fixed inset-0 z-50 flex bg-white animate-in fade-in duration-200 overflow-hidden">
                ...
                <div v-else class="space-y-6">
                    ...
                    <div v-if="currentFile.status === 'pending'" class="text-center py-4">
                        ...
                        <p class="text-sm text-yellow-500 font-bold mt-2">Daftar verifikasi Anda sedang diproses
                            oleh admin.</p>
                        <div class="mt-10 bg-white p-4 rounded-xl border-2 border-yellow-200 border-dashed text-center">
